        ...
        <section className="mx-auto max-w-6xl px-6 py-24">
          <div className="text-center mb-16">
            ...
            <p className="mt-4 text-muted-foreground max-w-xl mx-auto">
              Dibangun oleh tim yang bersemangat membantu UMKM Indonesia naik kelas melalui teknologi.
            </p>
          </div>
          
          <div className="flex flex-wrap justify-center gap-8 max-w-6xl mx-auto">
            {/* Oki */}
            <div className="group w-full max-w-xs relative rounded-2xl border border-border bg-card p-8 text-center transition-all hover:shadow-lg hover:border-foreground/20">
            ...
            <div className="group w-full max-w-xs relative rounded-2xl border border-border bg-card p-8 text-center transition-all hover:shadow-lg hover:border-foreground/20">
              <div className="mx-auto mb-6 h-28 w-28 overflow-hidden rounded-full border-2 border-border shadow-md transition-transform group-hover:scale-105">
                <img src="/Rika Amelya.jpeg" alt="Rika Ameliya" className="h-full w-full object-cover" />
              </div>
              <h3 className="text-lg font-bold">Rika Ameliya</h3>
              <p className="mt-1 text-sm font-medium text-primary">Quality Control</p>
              <p className="mt-3 text-sm text-muted-foreground leading-relaxed">
                Memastikan setiap produk memenuhi standar kualitas tertinggi sebelum sampai ke tangan pelanggan.
              </p>
              <a
                href="https://www.linkedin.com/in/rikaameliaz/"
                target="_blank"
                rel="noreferrer"
                className="mt-5 inline-flex items-center gap-2 rounded-lg border border-border bg-muted/50 px-4 py-2 text-sm font-medium text-foreground transition-colors hover:bg-foreground hover:text-background"
              >
            ...
            <div className="group w-full max-w-xs relative rounded-2xl border border-border bg-card p-8 text-center transition-all hover:shadow-lg hover:border-foreground/20">
              <div className="mx-auto mb-6 h-28 w-28 overflow-hidden rounded-full border-2 border-border shadow-md transition-transform group-hover:scale-105">
                <img src="/Tasya tammy.jpeg" alt="Tasya Tammy" className="h-full w-full object-cover" />
              </div>
              <h3 className="text-lg font-bold">Tasya Tammy</h3>
              <p className="mt-1 text-sm font-medium text-primary">Administrator</p>
              <p className="mt-3 text-sm text-muted-foreground leading-relaxed">
                Mengelola operasional dan administrasi untuk kelancaran layanan dan kepuasan pengguna.
              </p>
              <a
                href="https://www.instagram.com/tammykblmy_/"
                target="_blank"
                rel="noreferrer"
                className="mt-5 inline-flex items-center gap-2 rounded-lg border border-border bg-muted/50 px-4 py-2 text-sm font-medium text-foreground transition-colors hover:bg-foreground hover:text-background"
              >
            ...
            <div className="group w-full max-w-xs relative rounded-2xl border border-border bg-card p-8 text-center transition-all hover:shadow-lg hover:border-foreground/20">
              <div className="mx-auto mb-6 h-28 w-28 overflow-hidden rounded-full border-2 border-border shadow-md transition-transform group-hover:scale-105">
                <img src="/Aldin Ibnu.jpeg" alt="Aldin Ibnu" className="h-full w-full object-cover" />
              </div>
              <h3 className="text-lg font-bold">Aldin Ibnu</h3>
              <p className="mt-1 text-sm font-medium text-primary">UI/UX Designer</p>
              <p className="mt-3 text-sm text-muted-foreground leading-relaxed">
                Menghadirkan pengalaman visual yang menarik dan memastikan fungsionalitas aplikasi mudah digunakan.
              </p>
              <a
                href="https://www.instagram.com/_aldinibnu/"
                target="_blank"
                rel="noreferrer"
                className="mt-5 inline-flex items-center gap-2 rounded-lg border border-border bg-muted/50 px-4 py-2 text-sm font-medium text-foreground transition-colors hover:bg-foreground hover:text-background"
              >
