...
import { Plus, Package, ScanLine, ArrowRight, CalendarDays, Loader2, Trash2, QrCode, Eye, X, Download, TrendingUp, FileDown } from "lucide-react";
...
function Dashboard() {
  ...
  const fetchAll = async () => {
    try {
      ...
      setCreditScore(statsData.credit_score || 0);
