...
import { Coins, Check, Sparkles, History, X, QrCode as QrIcon } from "lucide-react";
          ...
          <div className="mt-5 flex flex-col items-center rounded-lg border border-dashed border-border bg-background/40 p-4 text-center">
            ...
            {deeplink && (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="mt-4 rounded-md bg-[#00AED6] px-6 py-2.5 text-sm font-semibold text-white shadow-sm hover:opacity-90"
              >
                Buka Aplikasi Gojek
              </a>
            )}
            <div className="mt-6 flex flex-col items-center gap-1.5">
              ...
              <p className="text-[11px] text-muted-foreground">Kredit akan otomatis bertambah setelah Anda membayar.</p>
            </div>
          </div>
        ) : (
          <>
